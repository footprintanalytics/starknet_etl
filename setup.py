...
setup(
    ...
    url='https://github.com/blockchain-etl/starknet-etl',
    ...
    entry_points={
        'console_scripts': [
            'starknetetl=starknetetl.cli:cli',
        ],
    },
    project_urls={
        'Bug Reports': 'https://github.com/blockchain-etl/starknet-etl/issues',
        'Chat': 'https://gitter.im/starknet-etl/Lobby',
        'Source': 'https://github.com/blockchain-etl/starknet-etl',
    },
)
